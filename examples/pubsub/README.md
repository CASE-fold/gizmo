...
We're going to set up two services to follow the pub/sub pattern using AWS SNS and AWS SQS.  One service is api-sns-pub and the other service is sqs-sub.  They can both be found at https://github.com/case-fold/gizmo/tree/master/examples/pubsub. For more information about pub/sub pattern, SNS, and SQS check out http://www.infoq.com/articles/AmazonPubSub. 
...
1. run `go get github.com/case-fold/gizmo` inside your $GOPATH folder
* run `cd $GOPATH/src/github.com/case-fold/gizmo/examples/pubsub/api-sns-pub`
* run `go get ./...`
...
1. run `cd $GOPATH/src/github.com/case-fold/gizmo/examples/pubsub/sqs-sub`
*  run `go get ./...`
